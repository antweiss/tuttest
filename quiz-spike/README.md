...
- **JSON:** `ensure_ascii=False`, ושמות שדות בעברית — למשל `מטא`, `נושאים`, לכל נושא `כותרת`, `שאלות`, ובכל שאלה `ניסוח`, `אפשרויות`, `אינדקס_תשובה_נכונה` (0–3), `משפט_מקור`. תוויות בדוח ה־PDF: **א–ד** במקום A–D.
